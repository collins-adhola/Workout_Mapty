...
class App {
  ...
  _loadMap(position) {
    ...
    // called here because map has to load first before the marker is set
  ...
  _newWorkout(e) {
    const validInputs = (...inputs) =>
      inputs.every(inp => Number.isFinite(inp)); // theis loops thru the vreated array from the spread operator to check if number.
